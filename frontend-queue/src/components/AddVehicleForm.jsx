  ...
  return (
    <div className="panel panel-accent-amber">
      <div className="panel-header">
        <div>
          <p className="panel-eyebrow">REGISTER</p>
          <h2 className="panel-heading">ADD VEHICLE</h2>
        </div>
      ...
      <form onSubmit={handleSubmit} className="panel-body space-y-4">
        <div>
          <label className="metric-label">TBS Vehicle Type</label>
        ...
        <div>
          <label className="metric-label">Plate Number</label>
